...
%% Text of abstract
  ...
  A physiological growth model such as 3-PG is advantageous because it
  ...
  The original 3-PG model does not include coppicing as a management
  ...
  The 3-PG model was validated against a number of field studies
  related to the growth of poplar as a SRWC biofuel feedstock.  The
  ...
  Important findings from the model include; validation of the 3-PG
  model for coppiced SRWC plantings, estimates of biomass feedstock
...
%% keywords here, in the form: keyword \sep keyword
  Short rotation woody crops \sep Poplar \sep 3-PG \sep Yield
