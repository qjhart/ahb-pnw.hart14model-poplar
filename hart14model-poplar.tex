...
The production of bioenergy feedstocks from marginal agricultural
lands can ensure that prime agricultural lands continue to produce
food crops. We interpreted the results of this modeling exercise to
evaluate the potential for production of hybrid polar \ac{SRWC} to
provide feedstock for biofuels restricting production to only lands
determined to be of relatively low value in agricultural food
production.  Annual growth on marginal lands in the study area is
estimated to be approximately 260 Mt/y.

\begin{table}[htbp]
  \centering
\begin{tabular}{lrrl}
State &  Annual growth (Mt/y)& Average yield (Mg/ha) & Marginal land
