...
\address[lawr]{Department of Land, Air, and Water, University of California, Davis, USA\fnref{lawr}}
...
\address[bioag]{Department of Biological and Agricultural Engineering, University of California, Davis, USA\fnref{bioag}}
...
\begin{abstract}
  ...
  of the United States, using appropriate climatological and soil
...
relatively coarse $8192$(m)$ \times 8192$(m). The spatial aggregation will necessarily result
...
the study region. A coarse geographic unit was selected to strike a
balance between geographic specificity and complexity of subsequent
modeling steps not covered in this paper. Another similar study~\cite{Headlee2012} used 32
...
Table~\ref{tab:pont-3pg} contains summarizes these inputs.  The parameter set
...
%  LocalWords:  isolines parameterizations allometric
