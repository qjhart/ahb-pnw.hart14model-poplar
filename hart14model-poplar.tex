...
agricultural production can ensure that prime agricultural lands continue to produce
food crops. We interpreted the results of this modeling exercise to
assess the potential production of hybrid polar \ac{SRWC} as biofuel
feedstock with minimal impact on agricultural land use. To accomplish
this we used the \ac{CDL} to identify landcover types associated with
grazing/pastureland and grasslands. Table~\ref{tab:growth} shows
production from this land base by state. These data reflect only land
areas within the study area (see Figure~\ref{fig:grid}). States
for which the data in Table~\ref{tab:growth} include the entire area
of the state are Washington, Oregon, and Idaho. Total annual growth on
marginal lands in the study area is estimated to be approximately 260
MMg/y. Further economic filters must be applied to assess the cost for
producing fuel from \ac{SRWC}, however this analysis shows that
feedstock produced from lands with little or no impact on
agricultural markets can contribute substantially to meeting
transportation energy needs for the region.
\begin{table}[htbp]
  \centering
\begin{tabular}{l | r | r | l}
State &  Annual growth (MMg/y)& Average yield (t/ac) & Marginal land
                                                     area (km\textsuperscript{2}) \\
\hline
Oregon & 117.59 & 9.60 &  2,141,559.1 \\
Washington & 96.33 & 7.18 &  2,346,141.7 \\
Idaho & 29.56 & 4.68 &  1,104,391.2 \\
California & 13.60 & 7.97 &    297,156.9 \\
Montana & 4.25 & 5.77 &    128,560.1 \\
Nevada & 0.12 & 2.45 &      8,805.0 \\
Utah & 0.06 & 4.96 &      2,134.2 \\
\end{tabular}
