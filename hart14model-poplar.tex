...
\address{Center for Forestry, University of California, Berkeley, USA\fnref{cf}}
...
\begin{abstract}
  ...
  non-irrigated regions, land cover features including ownership, slope
...
includes Washington, Oregon, Northern California, Idaho, and western Montana.  A regular grid partitions the region.  The individual pixel size is
relatively coarse $8192$(m)$ \times 8192$(m) or $2^{13}$~(m), and designed to reduce
some of the complexity of subsequent regional optimization models. The
spatial aggregation will necessarily result in yield estimates that do not
capture local variability. However, the intent of the study is to
identify areas of high productivity within the study region. Another
similar study \cite{Headlee2012} used 32 km\textsuperscript{2}
spatial resolution. 

The geographic projection used is an Albers equal area projection with standard
...
maintain a constant area. Other input datasets (climate, soils) were scaled to match the
...
from the University of British Columbia \ac{3pg} support website \footnote{\href{http://3pg.forestry.ubc.ca/}{http://3pg.forestry.ubc.ca/}}.  The functions were implemented in
...
\section{Results and Discussion}
 Results show an average annual yield over the entire region of 19.7 (Mg/ha).
...
non-irrigated lands predict an annual yield of 6.6 (Mg/ha) over an area under
consideration of 57000 ($km^2$).  In the case of non-irrigated yields, the
